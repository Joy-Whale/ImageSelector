...
class CropPhotoViewAttacher implements IPhotoView, View.OnTouchListener, OnGestureListener,
   ...
   public CropPhotoViewAttacher(ImageView imageView) {
...
//        if (null != observer) observer.addOnGlobalLayoutListener(this);
	   ...
	   mScaleDragDetector = CropVersionedGestureDetector.newInstance(imageView.getContext(), this);
...
//        return new Rect(edgeL, edgeT, edgeR, edgeB);
   ...
   private class AnimatedZoomRunnable implements Runnable {
	   ...
	   public void run() {
		   ...
		   if (t < 1f) {
			   CropCompat.postOnAnimation(imageView, this);
		   }
	   }
   ...
   private class FlingRunnable implements Runnable {
	   ...
	   private final CropScrollerProxy mScroller;
	   private int mCurrentX, mCurrentY;

	   public FlingRunnable(Context context) {
		   mScroller = CropScrollerProxy.getScroller(context);
	   }
