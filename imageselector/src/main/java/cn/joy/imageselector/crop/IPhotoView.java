...
interface IPhotoView {
	 ...
	 * @param listener - Listener to be registered.
	 */
	void setOnMatrixChangeListener(CropPhotoViewAttacher.OnMatrixChangedListener listener);
	 ...
	 */
	CropPhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
	 ...
	 * @param listener - Listener to be registered.
	 */
	void setOnPhotoTapListener(CropPhotoViewAttacher.OnPhotoTapListener listener);
	 ...
	 */
	CropPhotoViewAttacher.OnViewTapListener getOnViewTapListener();
	 ...
	 * @param listener - Listener to be registered.
	 */
	void setOnViewTapListener(CropPhotoViewAttacher.OnViewTapListener listener);
